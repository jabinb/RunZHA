...
namespace Server.Misc
{
	public class SkillCheck
	{
		...
		public static bool CheckSkill( Mobile from, Skill skill, object amObj, double chance )
		{
            ...
            //double SkillMod = (from.Skills[skill.SkillID].Value * 0.00865);
            //from.SendMessage(0x512, "SkillMod for {0} at {1} is {2}", skill.Name, from.Skills[skill.SkillID].Value, SkillMod);
			...
			if ( from.Alive && ( ( gc >= Utility.RandomDouble() && AllowGain( from, skill, amObj ) ) || skill.Base < 50.0 ) )
				Gain( from, skill );
		...
		public static void Gain( Mobile from, Skill skill )
		{
			...
			//if ( skill.SkillName == SkillName.Magery && from is BaseCreature )
			//	return;
