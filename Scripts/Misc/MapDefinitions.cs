...
namespace Server.Misc
{
	public class MapDefinitions
	{
		public static void Configure()
		{
			...
			RegisterMap( 1, 1, 0, 7168, 4096, 0, "Trammel",		MapRules.Internal ); //na85 - was RegisterMap( 1, 1, 1, 7168, 4096, 0, "Trammel",		MapRules.TrammelRules );
            RegisterMap( 2, 2, 2, 2304, 1600, 1, "Ilshenar",    MapRules.Internal);
            RegisterMap( 3, 3, 3, 2560, 2048, 1, "Malas",       MapRules.Internal);
            RegisterMap( 4, 4, 4, 1448, 1448, 1, "Tokuno",      MapRules.Internal);
			...
			*/
			...
			TileMatrixPatch.Enabled = true;	//na85 - was false.
											// setting to true is for OSI client patch > 6.0.0.0
		}
