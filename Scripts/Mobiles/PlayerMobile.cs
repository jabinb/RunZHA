...
namespace Server.Mobiles
{
	...
	public class PlayerMobile : Mobile, IHonorTarget
	{
		...
		[CommandProperty( AccessLevel.Developer )] //na85
        ...
        private ushort m_ZuluClassLevel = 0;
        ...
        [CommandProperty(AccessLevel.Developer)]
        public ushort ZuluClassLevel
        {
            get
            {
                if (m_ZuluClassLevel == 0 && m_ZuluClass != Unclassed.Instance)
                    RecalcZuluClass();

                return m_ZuluClassLevel;
            }
        }
        ...
        public void RecalcZuluClass()
        {
            m_ZuluClass = Unclassed.Instance; //Default class
            ushort level = 0;

            foreach (ZuluClass Classe in ZuluClass.Classes)
            {
                level = Classe.IsClassed(this);
                if (level > 0)
                {
                    m_ZuluClass = Classe;
                    break; //Found class
        ...
        */
        ...
        public Dictionary<BuffIcon, BuffInfo> BuffTable
        {
            get { return m_BuffTable; }
            set { m_BuffTable = value; }
        }
