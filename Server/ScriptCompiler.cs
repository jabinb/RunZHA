...
namespace Server
{
	public class ScriptCompiler
	{
		...
		public static bool CompileCSScripts( bool debug, bool cache, out Assembly assembly )
		{
            ...
            if (File.Exists("./RunZH.dll"))
            {
                /*
                AppDomain MyDomain = AppDomain.CurrentDomain;
                Assembly[] AssembliesLoaded = MyDomain.GetAssemblies();

                foreach (Assembly ass in AssembliesLoaded)
                {
                    AssemblyName name = ass.GetName();
                    if (name.Name == "RunZH.dll")
                    {
                        assembly = ass;
                ...
                assembly = Assembly.LoadFrom("./RunZH.dll");
                ...
                Console.WriteLine("done. Loaded RunZH.dll!");
