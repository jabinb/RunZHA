...
namespace Server {
	public static class World {
		...
		public static void Load() {
			...
			Console.WriteLine( "done ({1} items, {2} mobiles, {3} Cliloc strings) ({0:F2} seconds)", watch.Elapsed.TotalSeconds, m_Items.Count, m_Mobiles.Count, Item.ClilocList.Entries.Length );
		}
